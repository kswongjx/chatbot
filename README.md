...
fixed: Chat Widget Scrolling
added: Support to url links from bots
...
1.  **Clone this repository:**
    ```bash
    git clone https://github.com/kswongjx/chatbot.git
    cd YOUR_REPO_NAME
    ```
...
```json
{
  "output": "You can find more details on our <a href='https://www.example.com/pricing' target='_blank' rel='noopener noreferrer'>pricing page</a>."
}
```
